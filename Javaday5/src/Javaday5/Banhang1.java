...
//	JComboBox cmbhang = new JComboBox();
	JComboBox<String> cmbhang = new JComboBox<String>();
...
//		cmbhang.setModel(new DefaultComboBoxModel(new String[] {"Mi tom/10.000d", "Sting Vang/7.000d", "Sting Do/10.000d", "Com chien/20.000d"}));
